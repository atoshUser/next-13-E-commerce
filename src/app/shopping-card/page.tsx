...
const ShoppingCardPage = () => {
  ...
  return (
    <div className="h-screen bg-gray-100 pt-20 text-black">
      {!products.length ? (
        <div className="h-full flex  justify-center bg-slate-300">
          <div className="flex flex-col mt-20">
            <span className=" text-red-400 flex  justify-center">
              <NewReleasesIcon sx={{ width: "75px", height: "75px" }} />
            </span>
            ...
            <div className="flex items-center justify-center mt-8">
              <Link href={`/`}>
                <button className="flex justify-center items-center p-3 rounded-lg border border-indigo-500">
                  <span className="text-yellow-600 flex  font-semibold text-2xl gap-4">
                    GO
                    <span>
